...
class Repository {
    constructor(repository) {
        ...
        this._fsWatcher.onDidSvnAny((e) => __awaiter(this, void 0, void 0, function* () {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const run = () => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    const rootExists = yield fs_1.exists(this.workspaceRoot);
                    if (!rootExists) {
                        yield vscode_1.commands.executeCommand("svn.close", this);
                    }
                    throw err;
                }
                finally {
