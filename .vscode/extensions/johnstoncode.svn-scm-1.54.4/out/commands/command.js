...
class Command {
    ...
    _openResource(resource, against, preview, preserveFocus, preserveSelection) {
        return __awaiter(this, void 0, void 0, function* () {
            let left = yield this.getLeftResource(resource, against);
            ...
            if ((yield fs_1.exists(right.fsPath)) &&
                (yield fs_1.stat(right.fsPath)).isDirectory()) {
                return;
            }
            const opts = {
                preserveFocus,
    ...
    getLeftResource(resource, against = "") {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (resource.type === types_1.Status.CONFLICTED &&
                (yield fs_1.exists(resource.resourceUri.fsPath))) {
                const text = (yield fs_1.readFile(resource.resourceUri.fsPath, {
                    encoding: "utf8"
                }));
    ...
    showDiffPath(repository, content) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (yield fs_1.exists(tempFile)) {
                    try {
                        yield fs_1.unlink(tempFile);
                    }
                    catch (err) {
