...
class RepoLogProvider {
    constructor(model) {
        ...
        this.model.onDidChangeRepository((_e) => __awaiter(this, void 0, void 0, function* () {
            return this.refresh();
    ...
    addRepolikeGui() {
        ...
        box.onDidAccept(() => __awaiter(this, void 0, void 0, function* () {
    ...
    openFileRemoteCmd(element) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((yield common_1.checkIfFile(ri, false)) === false) {
                return;
            }
