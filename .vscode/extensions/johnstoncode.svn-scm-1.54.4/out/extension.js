...
const proposed_1 = require("./proposed");
...
function init(_context, outputChannel, disposables) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        disposables.push(new checkActiveEditor_1.CheckActiveEditor(model));
        disposables.push(new openRepositoryCount_1.OpenRepositoryCount(model));
